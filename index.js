...
async function welcome() {
    const rainbowTitle = chalkAnimation.rainbow('Who Wants to use command line calculator based on typescript? \n');
    await sleep();
    rainbowTitle.stop();
    console.log(`
...
async function handleAnswer(input, type) {
...
function winner() {
    ...
    figlet(`Your Answer Is  , ${result} !\n `, (err, data) => {
        ...
        console.log(chalk.green(`BY KANWAR SIKANDAR ALI`));
        process.exit(0);
    });
}
